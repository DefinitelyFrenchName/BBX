...
(bbh docs/method/oracle_classes.md v3).
...
Usage:
  python3 -m bbx.compare_window <a.log> <b.log> --onset N --end N [--reconverge N]

Logs: "<frame> <hash>" per line, END last. Exit 0 only if every clause holds.

Lifted VERBATIM from bbh lib/py/bbh/compare_window.py at f675710 (BBX slice S2 step 1, bbx-3, 2026-09-10): every printed line is
