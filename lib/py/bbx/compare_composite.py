...
(bbh docs/method/oracle_classes.md v4).
...
Usage:
  python3 -m bbx.compare_composite <base.log> <new.log> --flicker 829,2093 \\
...
Lifted VERBATIM from bbh lib/py/bbh/compare_composite.py at f675710 (BBX slice S2 step 1, bbx-3, 2026-09-10): every printed line is
