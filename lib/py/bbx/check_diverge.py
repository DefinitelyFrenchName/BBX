...
Usage:
    python3 -m bbx.check_diverge <log> <spec.diverge> <expected_root>

Exit 0 with "PASS ..." on stdout, 1 with "FAIL ..."/"NO-BASE-LOG ...".

Lifted VERBATIM from bbh lib/py/bbh/check_diverge.py at f675710 (BBX slice S2 step 1, bbx-3, 2026-09-10): every printed line is
