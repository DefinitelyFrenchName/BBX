...
(the FLICKER-TOLERATED class; bbh docs/method/oracle_classes.md v2).
...
Tolerance (from bbx.thresholds, deliberately tight):
...
Lifted VERBATIM from bbh lib/py/bbh/compare_flicker.py at f675710 (BBX slice S2 step 1, bbx-3, 2026-09-10): every printed line is
