...
- **bbx-28 (in progress, 2026-09-14): S6's plan is written and STOPPED at R59–R65** (`docs/plans/S6.md`); the opening
  battery at `35faa56` GREEN, PASS 34, controls 179 / 179 (`build/selftest_20260914T180055Z`). No S6 tool before the rulings.
- **R59–R65 open (bbx-28).** R0–R58 are answered; R58 (BBX-30's promoted tag) was raised and ruled at bbx-27, as recommended.
