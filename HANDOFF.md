...
- **No BBX-26 halt, and no ruling open.** R0–R50 are answered; R50 (BBX-25 is judged per comparison family
  ...
  CLOSE — bbx-25.
- **FIRST: S4's DONE ruling, unless the maintainer gave it after the close.** Option A and G57 are built,
  in one harness cycle; `gates/file_census.sh` PASSed at `e81417d` with its three controls fired; the
  per-component BBX-25 table and the amended §7 table are in `docs/readout.md` ("S4 — the slice readout,
  amended at bbx-25"). The question of which slice follows goes with it (S5 by the table, or R29's
  executable controls, S6, first; the contributor recommends S5, `DECISIONS_HISTORY.md` bbx-24). An answer
  given after the close is recorded in `DECISIONS_HISTORY.md` and `docs/slices.md` before any slice work.
