...
| `gates/readout.sh` | test | portable | — | the readout screen says what the kept run says — verdict, counts reconciled with the run's own tallies, controls, blind spots, BBX-14; | 2026-09-13 | 8 known-bad, 5 perturbed-copy | 5 |
