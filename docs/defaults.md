...
| D14 | quoted runtime of `bin/bbx selftest` | ~47 s (`real 47.08`) | `HANDOFF.md` | reference-calibrated | `/usr/bin/time -p bin/bbx selftest` with BBX_BBH_HOME set, 7 gates, macOS, 2026-09-09 |
